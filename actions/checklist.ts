...
export async function createTaskAction(
  ...
  if (error)
    return { ok: false, error: "Error creando tarea: " + error.message };
...
export async function updateTaskAction(
  ...
  if (error)
    return { ok: false, error: "Error guardando tarea: " + error.message };
...
export async function toggleTaskAction(
  ...
  if (error)
    return { ok: false, error: "Error actualizando tarea: " + error.message };
...
export async function deleteTaskAction(
  ...
  if (error)
    return { ok: false, error: "Error eliminando tarea: " + error.message };
